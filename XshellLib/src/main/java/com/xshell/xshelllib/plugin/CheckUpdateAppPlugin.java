...
public class CheckUpdateAppPlugin extends CordovaPlugin {
    ...
    public boolean execute(String action, CordovaArgs args, CallbackContext callbackContext) throws JSONException {
        ...
        if ("checkUpdate".equals(action)) {
            ...
            //获得本地app的更新时间，去请求。
            String url = configInfo.get("xversion-update-url") + "&appname=" + configInfo.get("xversion-app-name") + "&time=" + PreferenceUtil.getInstance(context).getAppUpdateTime();
            Log.i("zzy", "url:" + url);
    ...
    private void downloadApp(final String zipName) {
        ...
        PreferenceUtil.getInstance(context).setDownAppDir(FileUtil.getInstance(context).getFilePathInSDCard(AppConstants.XINYUSOFT_CACHE, AppConstants.APP_APK_NAME));
        final String file = FileUtil.getInstance(context).getFilePathInSDCard(AppConstants.XINYUSOFT_CACHE, AppConstants.APP_APK_NAME);
...
//                PreferenceUtil.getInstance().setAppUpdateTime(time);
    ...
    private void openApp() {
        ...
        Uri uri = Uri.fromFile(new File(PreferenceUtil.getInstance(context).getDownAppDir()));
