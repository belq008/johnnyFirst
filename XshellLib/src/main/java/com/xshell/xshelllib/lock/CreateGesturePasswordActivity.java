...
//import com.xshell.xshelllib.view.LockPatternView;
//import com.xshell.xshelllib.view.LockPatternView.Cell;
//import com.xshell.xshelllib.view.LockPatternView.DisplayMode;
//
...
//
//        //跳过
//        TextView gesturepwd_skip = (TextView) findViewById(R.id.gesturepwd_skip);
//        gesturepwd_skip.setOnClickListener(new OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                Intent intent = new Intent();
//                intent.setAction(InputPasswordActivity.BR_SKIP);
//                LocalBroadcastManager.getInstance(CreateGesturePasswordActivity.this).sendBroadcast(intent);
...
//
//        //重新设置
//        tv_reset = (TextView) findViewById(R.id.gesturepwd_reset);
...
//                    Toast.makeText(CreateGesturePasswordActivity.this, "您还没有设置手势密码！", Toast.LENGTH_SHORT).show();
//                } else {
//                    tv_reset.setVisibility(View.INVISIBLE);
//                    mChosenPattern = null;
//                    clearPreviewViews();
...
//        });
//
//        createLock = getIntent().getIntExtra("createLock", -1);
//        Log.i("zzy","createLock:"+ createLock);
//    }
//
...
//            View[] mPreviewView = mPreviewViews[i];
//            for (int j = 0; j < mPreviewView.length; j++) {
//                mPreviewView[j].setBackgroundColor(getResources().getColor(R.color.color_hei_8));
//            }
//
//        }
//    }
...
//            mPreviewViews[cell.getRow()][cell.getColumn()].setBackgroundResource(R.drawable.xinyusoft_gesture_create_grid_selected);
//
//        }
//    }
//
