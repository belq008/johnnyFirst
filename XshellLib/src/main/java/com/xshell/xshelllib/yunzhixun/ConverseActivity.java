...
import com.xshell.xshelllib.yunzhixun.domian.TelListsInfo;
import com.xshell.xshelllib.yunzhixun.domian.TelListsInfoDBManager;
import com.xshell.xshelllib.yunzhixun.domian.TelUsersInfo;
import com.xshell.xshelllib.yunzhixun.domian.UIDfineAction;
import com.xshell.xshelllib.yunzhixun.domian.UserSetting;
import com.xshell.xshelllib.yunzhixun.domian.UserSettingsDbManager;
...
public class ConverseActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        phone = (String) SharedPreferencesUtils.getParam(this, "PHONE", "");
        LogUtils.e("huang", "new UserInfo().getAccount():" + phone);
    }
    ...
    protected void addCallRecord(final int dailFlag, final boolean inCall,
        ...
        new Thread() {
            public void run() {
                ...
                //获取当前用户登入的电话号码
//				user.setLoginPhone(getSharedPreferences("YZX_DEMO", 0).getString("YZX_ACCOUNT_INDEX", ""));
